...
if TYPE_CHECKING:
    from ..models.imbalance_price_revision import ImbalancePriceRevision


T = TypeVar("T", bound="ImbalancePriceHistory")


@_attrs_define
class ImbalancePriceHistory:
    """
    Attributes:
        area (Area): Area code
        ...
        prices (list[ImbalancePriceRevision]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for prices_item_data in _prices:
            prices_item = ImbalancePriceRevision.from_dict(prices_item_data)

            prices.append(prices_item)

        imbalance_price_history = cls(
            area=area,
            eic_code=eic_code,
            currency=currency,
            direction=direction,
        ...
        imbalance_price_history.additional_properties = d
        return imbalance_price_history
