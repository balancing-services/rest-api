...
T = TypeVar("T", bound="BalancingEnergyActivatedVolumeRevision")


@_attrs_define
class BalancingEnergyActivatedVolumeRevision:
    """
    Attributes:
        period (Period):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        balancing_energy_activated_volume_revision = cls(
            period=period,
            volume_in_mw=volume_in_mw,
            observed_at=observed_at,
        )

        balancing_energy_activated_volume_revision.additional_properties = d
        return balancing_energy_activated_volume_revision
