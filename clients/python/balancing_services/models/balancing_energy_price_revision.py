...
T = TypeVar("T", bound="BalancingEnergyPriceRevision")


@_attrs_define
class BalancingEnergyPriceRevision:
    """
    Attributes:
        period (Period):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        balancing_energy_price_revision = cls(
            period=period,
            price_per_mwh=price_per_mwh,
            observed_at=observed_at,
        )

        balancing_energy_price_revision.additional_properties = d
        return balancing_energy_price_revision
