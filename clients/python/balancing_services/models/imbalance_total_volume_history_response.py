...
if TYPE_CHECKING:
    from ..models.imbalance_total_volume_history import ImbalanceTotalVolumeHistory
    from ..models.period import Period


T = TypeVar("T", bound="ImbalanceTotalVolumeHistoryResponse")


@_attrs_define
class ImbalanceTotalVolumeHistoryResponse:
    """
    Attributes:
        queried_period (Period):
        data (list[ImbalanceTotalVolumeHistory]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ImbalanceTotalVolumeHistory.from_dict(data_item_data)
        ...
        imbalance_total_volume_history_response = cls(
        ...
        imbalance_total_volume_history_response.additional_properties = d
        return imbalance_total_volume_history_response
