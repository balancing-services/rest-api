...
if TYPE_CHECKING:
    from ..models.cross_border_available_capacity import CrossBorderAvailableCapacity
    from ..models.period import Period


T = TypeVar("T", bound="CrossBorderAvailableCapacityResponse")


@_attrs_define
class CrossBorderAvailableCapacityResponse:
    """
    Attributes:
        queried_period (Period):
        data (list[CrossBorderAvailableCapacity]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.cross_border_available_capacity import (
        ...
        for data_item_data in _data:
            data_item = CrossBorderAvailableCapacity.from_dict(data_item_data)
        ...
        cross_border_available_capacity_response = cls(
        ...
        cross_border_available_capacity_response.additional_properties = d
        return cross_border_available_capacity_response
