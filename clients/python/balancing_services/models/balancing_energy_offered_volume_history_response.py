...
if TYPE_CHECKING:
    from ..models.balancing_energy_offered_volume_history import (
        BalancingEnergyOfferedVolumeHistory,
    )
    from ..models.period import Period


T = TypeVar("T", bound="BalancingEnergyOfferedVolumeHistoryResponse")


@_attrs_define
class BalancingEnergyOfferedVolumeHistoryResponse:
    """
    Attributes:
        queried_period (Period):
        data (list[BalancingEnergyOfferedVolumeHistory]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = BalancingEnergyOfferedVolumeHistory.from_dict(data_item_data)
        ...
        balancing_energy_offered_volume_history_response = cls(
        ...
        balancing_energy_offered_volume_history_response.additional_properties = d
        return balancing_energy_offered_volume_history_response
