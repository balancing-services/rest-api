...
if TYPE_CHECKING:
    from ..models.imbalance_price_history import ImbalancePriceHistory
    from ..models.period import Period


T = TypeVar("T", bound="ImbalancePriceHistoryResponse")


@_attrs_define
class ImbalancePriceHistoryResponse:
    """
    Attributes:
        queried_period (Period):
        data (list[ImbalancePriceHistory]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ImbalancePriceHistory.from_dict(data_item_data)
        ...
        imbalance_price_history_response = cls(
        ...
        imbalance_price_history_response.additional_properties = d
        return imbalance_price_history_response
