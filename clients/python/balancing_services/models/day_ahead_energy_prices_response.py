...
if TYPE_CHECKING:
    from ..models.day_ahead_energy_prices import DayAheadEnergyPrices
    from ..models.period import Period


T = TypeVar("T", bound="DayAheadEnergyPricesResponse")


@_attrs_define
class DayAheadEnergyPricesResponse:
    """
    Attributes:
        queried_period (Period):
        data (list[DayAheadEnergyPrices]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = DayAheadEnergyPrices.from_dict(data_item_data)
        ...
        day_ahead_energy_prices_response = cls(
        ...
        day_ahead_energy_prices_response.additional_properties = d
        return day_ahead_energy_prices_response
