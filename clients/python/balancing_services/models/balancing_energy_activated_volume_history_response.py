...
if TYPE_CHECKING:
    from ..models.balancing_energy_activated_volume_history import (
        BalancingEnergyActivatedVolumeHistory,
    )
    from ..models.period import Period


T = TypeVar("T", bound="BalancingEnergyActivatedVolumeHistoryResponse")


@_attrs_define
class BalancingEnergyActivatedVolumeHistoryResponse:
    """
    Attributes:
        queried_period (Period):
        data (list[BalancingEnergyActivatedVolumeHistory]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = BalancingEnergyActivatedVolumeHistory.from_dict(data_item_data)
        ...
        balancing_energy_activated_volume_history_response = cls(
        ...
        balancing_energy_activated_volume_history_response.additional_properties = d
        return balancing_energy_activated_volume_history_response
