...
if TYPE_CHECKING:
    from ..models.balancing_energy_price_history import BalancingEnergyPriceHistory
    from ..models.period import Period


T = TypeVar("T", bound="BalancingEnergyPriceHistoryResponse")


@_attrs_define
class BalancingEnergyPriceHistoryResponse:
    """
    Attributes:
        queried_period (Period):
        data (list[BalancingEnergyPriceHistory]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = BalancingEnergyPriceHistory.from_dict(data_item_data)
        ...
        balancing_energy_price_history_response = cls(
        ...
        balancing_energy_price_history_response.additional_properties = d
        return balancing_energy_price_history_response
