...
if TYPE_CHECKING:
    from ..models.balancing_energy_activated_volume_revision import (
        BalancingEnergyActivatedVolumeRevision,
    )


T = TypeVar("T", bound="BalancingEnergyActivatedVolumeHistory")


@_attrs_define
class BalancingEnergyActivatedVolumeHistory:
    """
    Attributes:
        area (Area): Area code
        ...
        volumes (list[BalancingEnergyActivatedVolumeRevision]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for volumes_item_data in _volumes:
            volumes_item = BalancingEnergyActivatedVolumeRevision.from_dict(
                volumes_item_data
            )

            volumes.append(volumes_item)

        balancing_energy_activated_volume_history = cls(
            area=area,
            eic_code=eic_code,
        ...
        balancing_energy_activated_volume_history.additional_properties = d
        return balancing_energy_activated_volume_history
