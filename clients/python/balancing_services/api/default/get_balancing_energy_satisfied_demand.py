...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/balancing/energy/satisfied-demand",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get satisfied balancing energy demand

     **EXPERIMENTAL**: Returns satisfied balancing energy demand for the specified area within the given
    time period,
    i.e. the part of the TSO's balancing energy demand that was satisfied. Satisfied demand is expressed
    as (average) power in MW.
