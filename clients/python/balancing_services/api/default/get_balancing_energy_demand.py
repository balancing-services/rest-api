...
def sync_detailed(
    *,
    ...
    """Get balancing energy demand

     **EXPERIMENTAL**: Returns balancing energy demand for the specified area within the given time
    period,
    i.e. the balancing energy requested by the TSO. Demand is expressed as (average) power in MW.
