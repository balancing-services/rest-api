...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/balancing/energy/cross-border-marginal-prices",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CrossBorderMarginalPricesResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns cross-border purchased marginal prices (CBPMs) for the specified area and reserve type
    within the given time period.
    Supports cursor-based pagination for large result sets.

    Args:
        area (Area): Area code
        period_start_at (datetime.datetime):  Example: 2026-03-01T00:00:00Z.
        period_end_at (datetime.datetime):  Example: 2026-03-01T01:00:00Z.
...
def sync(
    *,
    ...
    Returns:
        CrossBorderMarginalPricesResponse | Problem
    """
